...
namespace GameDevTV.Saving
{
    ...
    public class SaveableEntity : MonoBehaviour
    {
        ...
        private void Update() {
            ...
            // We avoid the prefabs generate the UUIDs. Only instancied (live) gameobjects in a scene should have it.
            if (string.IsNullOrEmpty(gameObject.scene.path)) return;
            // SerializedObject not available when building the game.
